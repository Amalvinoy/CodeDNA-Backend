...
exports.DnaCalculator = void 0;
const strengthAnalyzer_1 = require("./strengthAnalyzer");
const weaknessAnalyzer_1 = require("./weaknessAnalyzer");
const trendAnalyzer_1 = require("./trendAnalyzer");
const consistencyAnalyzer_1 = require("./consistencyAnalyzer");
class DnaCalculator {
    static calculateProfile(userId, reviews) {
        ...
        const categories = ['correctness', 'security', 'performance', 'architecture', 'maintainability', 'style'];
        ...
        categories.forEach((cat) => {
            ...
            sorted.forEach((r, idx) => {
                ...
                const val = r.metrics?.[cat] ?? (r.qualityScore || 8.0);
        ...
        const overallCategoryAvg = (categoryScores.correctness * 0.25 +
        ...
        // 3. Consistency Score
        const consistencyScore = consistencyAnalyzer_1.ConsistencyAnalyzer.calculateConsistency(sorted);
        // 4. Strengths
        const strengths = strengthAnalyzer_1.StrengthAnalyzer.analyzeStrengths(sorted, categoryScores);
        // 5. Patterns and Recurring Weaknesses
        const { allPatterns, recurringWeaknesses, areasForOptimization, patternHistory } = weaknessAnalyzer_1.WeaknessAnalyzer.analyzePatternsAndWeaknesses(sorted);
        // 6. Trends and Trajectory
        const { trends, evolutionTrajectory, improvementMonthPercent } = trendAnalyzer_1.TrendAnalyzer.analyzeTrends(sorted);
        ...
        sorted.forEach((r) => {
            if (r.language) {
                ...
                const displayLang = raw === 'typescript' || raw === 'ts'
                    ? 'TypeScript'
...
exports.DnaCalculator = DnaCalculator;
//# sourceMappingURL=dnaCalculator.js.map