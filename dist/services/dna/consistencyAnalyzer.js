...
exports.ConsistencyAnalyzer = void 0;
class ConsistencyAnalyzer {
    static calculateConsistency(reviews) {
        if (!reviews || reviews.length <= 1) {
            return 90; // baseline consistency for single review
        }
        const scores = reviews.map((r) => r.qualityScore <= 10 ? r.qualityScore * 10 : r.qualityScore);
...
exports.ConsistencyAnalyzer = ConsistencyAnalyzer;
