...
exports.RiskFeatureExtractor = void 0;
class RiskFeatureExtractor {
    static extractFeatures(request) {
        const evidence = [];
        const categoryFindingCounts = {
            security: 0,
            performance: 0,
            correctness: 0,
            architecture: 0,
...
exports.RiskFeatureExtractor = RiskFeatureExtractor;
//# sourceMappingURL=riskFeatureExtractor.js.map